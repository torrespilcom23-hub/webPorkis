...
class CerdoForm(forms.ModelForm):
    """El arete se autogenera (A-0001, A-0002...); no se edita manualmente."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['categoria'].help_text = (
            'Opcional al registrar, pero recomendada para cerdos en granja '
            '(Lechón, Engorde, Pie de cría…). Los vendidos o fallecidos no '
            'cuentan en el aviso de “sin categoría”.'
        )
